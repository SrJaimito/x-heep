...
#pragma message ( "the x-heep.h for NewAE Bergen board is used" )
...
// The Bergen board provides an external PLL chip that drives
// the FPGA's clock signal. Macro BERGEN_PLL_MHZ can be used
// to specify this frequency.
#ifdef BERGEN_PLL_MHZ
    #define REFERENCE_CLOCK_Hz (BERGEN_PLL_MHZ * 1000 * 1000)
#else
